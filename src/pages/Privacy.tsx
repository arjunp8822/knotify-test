const Privacy = () => {
  return (
    <div>
      <h2 className="font-semibold text-lg sm:text-xl mb-12 mt-8 sm:mt-12">
        Privacy Policy
      </h2>
      <div className="flex flex-col gap-4 mb-8">
        <h4 className="font-medium">1. Purpose</h4>
        <p className="text-sm sm:text-base">
          Knotify Pty Ltd trading as Knotify respects your right to privacy and
          is committed to safeguarding the privacy of our customers and website
          visitors. We adhere to the Australian Privacy Principles contained in
          the Privacy Act 1988 (Cth). This policy sets out how we collect and
          treat your personal information. "Personal information" is information
          we hold which is identifiable as being about you.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-4 mb-8">
        ...
        <p className="text-sm sm:text-base">
          Knotify will, from time to time, receive and store personal
          information you enter onto our website, provided to us directly or
          given to us in other forms. You may provide basic information such as
          your name, phone number, address and email address to enable us to
          send information, provide updates and process your product or service
          order. We may collect additional information at other times, including
          ...
          provide financial or credit card information, or communicate with our
          customer support. Additionally, we may also collect any other
      ...
      <div className="flex flex-col gap-4 mb-8">
        ...
        <p className="text-sm sm:text-base">
          Knotify collects personal information from you in a variety of ways,
      ...
      <div className="flex flex-col gap-4 mb-8">
        ...
        <p className="text-sm sm:text-base">
          Knotify may use personal information collected from you to provide you
          with information, updates and our services. We may also make you aware
          of new and additional products, services and opportunities available
          to you. We may use your personal information to improve our products
          and services and better understand your needs. Knotify may contact you
      ...
      <div className="flex flex-col gap-4 mb-8">
        ...
        <p className="text-sm sm:text-base">
          ...
          party when it is required for the delivery of our services. We may
          from time to time need to disclose personal information to comply with
          a legal requirement, such as a law, regulation, court order, subpoena,
          warrant, in the course of a legal proceeding or in response to a law
          enforcement agency request. We may also use your personal information
          to protect the copyright, trademarks, legal rights, property or safety
          of Knotify, www.knotify.com.au, its customers or third parties.
          ...
          Australia. If there is a change of control in our business or a sale
          or transfer of business assets, we reserve the right to transfer to
          ...
          databases. This information may be disclosed to a potential purchaser
          under an agreement to maintain confidentiality. We would seek to only
      ...
      <div className="flex flex-col gap-4 mb-8">
        ...
        <p className="text-sm sm:text-base">
          Knotify is committed to ensuring that the information you provide to
      ...
      <div className="flex flex-col gap-4 mb-8">
        ...
        <p className="text-sm sm:text-base">
          ...
          email us at privacy@knotify.com.au. We reserve the right to refuse to
      ...
      <div className="flex flex-col gap-4 mb-8">
        ...
        <p className="text-sm sm:text-base">
          ...
          us at privacy@knotify.com.au. We take complaints very seriously and
          will respond shortly after receiving notice of your complaint.
        </p>
      </div>

      <div className="flex flex-col gap-4 mb-8">
        <h4 className="font-medium">4. Changes to Privacy Policy</h4>
        <p className="text-sm sm:text-base">
          ...
          modifications on our website. Please check back from time to time to
      ...
      <div className="flex flex-col gap-4 mb-8">
        ...
        <p className="text-sm sm:text-base">
          When you come to our website (www.knotify.com.au) we may collect
          certain information such as browser type, operating system, website
          visited immediately before coming to our site, etc. This information
          is used in an aggregated manner to analyse how people use our site,
          such that we can improve our service.
        </p>
      </div>

      <div className="flex flex-col gap-4 mb-8">
        <h4 className="font-medium">5.1. Cookies</h4>
        <p className="text-sm sm:text-base">
      ...
      <div className="flex flex-col gap-4 mb-8">
        <h4 className="font-medium">5.2. Third party sites</h4>
        <p className="text-sm sm:text-base">
          Our site may from time to time have links to other websites not owned
          ...
          Knotify is not responsible for the privacy practices of other such
