  ...
  return (
    <div>
      <div className="container">
        <h2 className="font-semibold text-lg sm:text-xl mb-12">
          Privacy Policy
        </h2>
        <div className="flex flex-col gap-4 mb-8">
          <h4 className="font-medium">1. Purpose</h4>
          <p className="text-sm sm:text-base">
            Knotify Pty Ltd trading as Knotify respects your right to privacy
            ...
            contained in the Privacy Act 1988 (Cth). This policy sets out how we
            collect and treat your personal information. "Personal information"
        ...
        <div className="flex flex-col gap-4 mb-8">
          ...
          <p className="text-sm sm:text-base">
            Knotify may use personal information collected from you to provide
            ...
            our products and services and better understand your needs. Knotify
        ...
        <div className="flex flex-col gap-4 mb-8">
          ...
          <p className="text-sm sm:text-base">
            ...
            from time to time need to disclose personal information to comply
            with a legal requirement, such as a law, regulation, court order,
            ...
            rights, property or safety of Knotify, www.knotify.com.au, its
            customers or third parties. Information that we collect may from
        ...
        <div className="flex flex-col gap-4 mb-8">
          ...
          <p className="text-sm sm:text-base">
            ...
            please email us at privacy@knotify.com.au. We reserve the right to
        ...
        <div className="flex flex-col gap-4 mb-8">
          ...
          <p className="text-sm sm:text-base">
            ...
            our posting of the modifications on our website. Please check back
            from time to time to review our Privacy Policy.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4 mb-8">
          ...
          <p className="text-sm sm:text-base">
            ...
            aware that Knotify is not responsible for the privacy practices of
